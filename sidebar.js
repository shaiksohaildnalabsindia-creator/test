    ...
    <div class="sidebar-menu">
      <div class="menu-section">
        ...
        <div class="menu-items">
          <a href="parcel_entry" class="menu-item" data-page="parcel_entry">
            <span class="menu-item-icon">📦</span><span class="menu-item-text">Parcel Entry</span>
          </a>
          <a href="parcel_entry_form" class="menu-item" data-page="parcel_entry_form">
            <span class="menu-item-icon">🔍</span><span class="menu-item-text">Parcel Scanner</span>
          </a>
          <a href="upload_sample_images" class="menu-item" data-page="upload_sample_images">
